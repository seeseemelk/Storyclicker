...
function moment_intro()
	...
	sc ("Hi " .. name .. ", nice to see you! Now, you will not be playing this game as yourself, but as a girl called...")
	sc "Leia!"
	sc "Are you ready!?"
...
function moment_schoolclass()
	...
	elseif o == "chemistry" then
		--sc "You do your best to hold your laugh while Abudosan accidentally sets the teacher on fire."
		sc "You help Abudosan produce sulfuric acid to use on one of the teachers."
...
function moment_meetdurinusu()
	...
	elseif o == "c" then
		...
		sc "Durinusu: What? How did you know that? Are you a psychic?"
		sc "Leia: Just wondering..."
		sc "Durinusu: Well, yes I am. But I want to be a Texas Ranger! Or a Power Ranger!"
	elseif o == "d" then
...
function moment_schooltalk()
	if getDay() == 1 then
		moment_firstday()
		fadein(1)
	elseif getDay() == 2 then
		moment_secondday()
		fadein(1)
	elseif getDay() == 3 then
		moment_thirdday()
		fadein(1)
	elseif getDay() == 4 then
		clear()
		fadeout(1)
